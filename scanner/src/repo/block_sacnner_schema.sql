...
ALTER TABLE public.account_api_plans_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_custom_abis_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_identities_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_public_tags_requests_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_tag_addresses_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_tag_transactions_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_watchlist_addresses_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_watchlist_notifications_id_seq OWNER TO postgres;
...
ALTER TABLE public.account_watchlists_id_seq OWNER TO postgres;
...
ALTER TABLE public.address_tags_id_seq OWNER TO postgres;
...
ALTER TABLE public.address_to_tags_id_seq OWNER TO postgres;
...
ALTER TABLE public.missing_block_ranges_id_seq OWNER TO postgres;
...
ALTER TABLE public.token_transfer_token_id_migrator_progress_id_seq OWNER TO postgres;
...
--
-- Name: account_watchlist_notifications account_watchlist_notifications_watchlist_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.account_watchlist_notifications
    ADD CONSTRAINT account_watchlist_notifications_watchlist_address_id_fkey FOREIGN KEY (watchlist_address_id) REFERENCES public.account_watchlist_addresses(id) ON DELETE CASCADE;
